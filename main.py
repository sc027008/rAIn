...
def main():
    ...
    # 条件2: 降り始めまたは雨量ランクが上昇した場合の「アメデス」通知
        ...
        formatted_text = f"<font color=\"{color_code}\">10分後: <b>{rain_desc}</b> {val_str} mm/h</font>"
    ...
    # 条件3: 雨が止んだ場合の「雨上がりの予感」通知
        ...
        formatted_text = f"<font color=\"{color_code}\">10分後: <b>{rain_desc}</b></font>"
...
def test_forced_notification():
    ...
    try:
        ...
        # 17時以外の時間帯でも main() 内の17時判定を通過させるため、時刻取得を17:05に固定モック化
